...
/>
<button style={{width:"150px", fontSize:"16px",border:"0",background:"yellowgreen", color:"white",borderRadius:"5px",padding:"10px"}} onClick={handleAddNote}>Add Note</button>
</div>
    </div>
  );
};
